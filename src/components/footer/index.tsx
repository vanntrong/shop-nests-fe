...
const Footer = () => {
  return (
    <footer className="mt-10 bg-primary pb-6">
      <div className="flex">
        {BRAND_BENEFIT.map((benefit, index) => (
          <div key={`benefit-${index}`} className="basis-4/12">
            <Image
              src={benefit}
              width={768}
              height={345}
      ...
      <div className="flex-center relative px-4 pt-4">
        <Image
        ...
        />
        <h2 className="z-1 relative text-center text-lg font-normal text-white">
      ...
      <div className="bg-primary px-2 pt-4">
        ...
        <p className="mt-4 text-center text-sm leading-[1.5] text-white">
          Điều đặc biệt làm nên và chỉ có duy nhất ở Yến Vàng là khách hàng không còn phải đau đầu
          chọn lựa và lo lắng về chất lượng, hiệu quả hay mẫu mã của sản phẩm nữa mà vẫn có giá
          thành luôn tốt nhất.
        </p>
